...
* Dateiaufruf mit gleichzeitigem Datenimport **generell mittels eines http-requests** .<br>Chrome and Opera verhindern XMLHttpRequest zu lokalen Dateien (Z.B. JSON, CSV, etc.).<br>`XMLHttpRequest cannot load file:///C:/locationoffile..../mydata.json. Cross origin requests are only supported for HTTP`
