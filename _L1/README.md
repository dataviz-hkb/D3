...
* Mehrfach-Selektion ist möglich über die Verwendung von Kommata. <br>Beispiel: Gegeben die Elemente <body> … </body>` , `<p id="testID"> … </p>` und `<h1> … </h1>` diese werden in CSS über die Syntax `body, #testID, h1 { … }` gemeinsam selektiert
