...
#####mit:
* dem vorangestellten Punkt: &nbsp;__&middot;__&nbsp; wird der Bezeichner als Klassen-Selektor interpretiert <br>```htmlBeispiel: `.testKlasse { … }` (CSS) selektiert `<p class="testKlasse">` (HTML) ```

* dem vorangestellten Hash: &nbsp;__#__&nbsp; wird der Bezeichner als ID-Selektor interpretiert <br>Beispiel: `#testID { … }` (CSS) selektiert `<p id="testID">` (HTML) 
