...
#####mit:
* dem vorangestellten Punkt: &nbsp;__&middot;__&nbsp; wird der Bezeichner als Klassen-Selektor interpretiert. Beispiel:<br>``` .testKlasse { … }  selektiert <p class="testKlasse">  ```

* dem vorangestellten Hash: &nbsp;__#__&nbsp; wird der Bezeichner als ID-Selektor interpretiert. Beispiel:<br> ```  #testID { … }  selektiert <p id="testKlasse">  ``` 
