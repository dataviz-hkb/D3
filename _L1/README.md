...
* Mehrfach-Selektion ist möglich über die Verwendung von Kommata. <br>Beispiel: Die Elemente `<body> … </body>` `<p id="testID"> … </p>` `<h1> … </h1>` werden gemeinsam in CSS über `body, #testID, h1 { … }`selektiert
